        ...
        <div class="main">
            ...
            <table class="bill-items-table" style="margin-top: 5px">
                <thead>
                    <tr>
                        <th style="width: 4%">#</th>
                        <th class="col-desc" style="width: 22%">Description</th>
                        <th style="width: 6%">Qty</th>
                        <th style="width: 8%">Price</th>
                        <th style="width: 5%">Disc%</th>
                        <th style="width: 9%">Amount</th>
                        <th style="width: 6%">ST%</th>
                        <th style="width: 8%">ST Amt</th>
                        <th style="width: 6%">IT%</th>
                        <th style="width: 8%">IT Amt</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="num" style="font-weight: bold"><?php echo number_format($discountPercentage, 0); ?>%</td>
                            <td class="num" style="font-weight: bold"><?php echo number_format($lineAmountAfterDiscount, 2); ?></td>
                            <td class="num" style="font-weight: bold"><?php echo number_format($saleTaxPct, 0); ?>%</td>
                            <td class="num" style="font-weight: bold"><?php echo number_format($rowSaleTaxAmount, 2); ?></td>
                            <td class="num" style="font-weight: bold"><?php echo number_format($incomeTaxPct, 0); ?>%</td>
                            <td class="num" style="font-weight: bold"><?php echo number_format($rowIncomeTaxAmount, 2); ?></td>
                        </tr>
                    <?php
                    }
                    ...
                    <tr>
                        <th colspan="6" style="font-size: 10px; border-top: 2px solid black; text-align:right;">Total Amount:</th>
                        <th colspan="4" style="font-size: 10px; border-top: 2px solid black; text-align:right;">{{ number_format($totalAmountBeforeDiscount, 2) }}</th>
                    </tr>
                    <tr>
                        <th colspan="6" style="font-size: 10px; text-align:right;">Total Discount:</th>
                        <th colspan="4" style="font-size: 10px; text-align:right;">{{ number_format($totalDiscountAmount, 2) }}</th>
                    </tr>
                    <tr>
                        <th colspan="6" style="font-size: 10px; text-align:right;">Invoice Discount:</th>
                        <th colspan="4" style="font-size: 10px; text-align:right;">{{ number_format($invoiceDiscount, 2) }}</th>
                    </tr>
                    <tr>
                        <th colspan="6" style="font-size: 10px; text-align:right;">Amount After Discount:</th>
                        <th colspan="4" style="font-size: 10px; text-align:right;">{{ number_format($amountAfterDiscount, 2) }}</th>
                    </tr>
                    <tr>
                        <th colspan="6" style="font-size: 10px; text-align:right;">Total Sale Tax:</th>
                        <th colspan="2" style="font-size: 10px; text-align:right;">{{ number_format($totalRowSaleTax, 2) }}</th>
                        <th colspan="2" style="font-size: 10px; text-align:right;">Total Income Tax:</th>
                        <th colspan="2" style="font-size: 10px; text-align:right;">{{ number_format($totalRowIncomeTax, 2) }}</th>
                    </tr>
                    @foreach($saleTaxLines as $saleTaxLine)
                    <tr>
                        <th colspan="6" style="font-size: 10px; text-align:right;">{{ $saleTaxLine['name'] }}@if(!empty($saleTaxLine['percentage'])) ({{ number_format($saleTaxLine['percentage'], 0) }}%)@endif:</th>
                        <th colspan="4" style="font-size: 10px; text-align:right;">{{ number_format($saleTaxLine['amount'], 2) }}</th>
                    </tr>
                    @endforeach
                    <tr>
                        <th colspan="6" style="font-size: 12px; text-align:right;">Net Bill Amount:</th>
                        <th colspan="4" style="font-size: 12px; text-align:right;">{{ number_format($netTotal, 2) }}</th>
                    </tr>
                </tbody>
            </table>
        </div>
